...
void select_sleep(void) {
        ...
        if (sleepgage > 90){
                printf("건냥 is already deep sleep\n\n");
                sleep(2);
        }//최대 게이지 100넘는 것 방지
        else {
...
void savecatimage(void) { //고양이 이미지 저장
...
int main(void) {
        ...
        printf("~!~!건냥이 키우기~!~!\n건냥이의 만족도가 하나라도 0이 되면 건냥>이 키우기 실패!\nlevel 10이 되면 건냥이 키우기 성공!\n만족도를 유지시켜 건냥이를
 무사히 키워주세요(=oωo=)");
        printf("\n  |￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣|\n　|!!!!게임이  시작되었습>니다!!!!|            　  \n　|＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿|\n　　　 ∧∧  ||\n　
　 ( ○?○)||\n　　　/　つΦ\n");
        printf("~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~\n");
